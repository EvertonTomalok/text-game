...
var MainQuestions []map[uint]Question = []map[uint]Question{
	{
		1: Question{
			ID:   1,
			Text: "Opss... We have a trouble with our application. What should we do?",
			FirstAlternative: QuestionAlternative{
				Text:                     "Tell the team to a war room.",
				RedirectTo:               1,
