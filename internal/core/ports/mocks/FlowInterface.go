...
func (_m *FlowInterface) FlowValidator(flow *config.Flow) error {
	ret := _m.Called(flow)
...
type mockConstructorTestingTNewFlowInterface interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewFlowInterface(t mockConstructorTestingTNewFlowInterface) *FlowInterface {
	mock := &FlowInterface{}
	mock.Mock.Test(t)
